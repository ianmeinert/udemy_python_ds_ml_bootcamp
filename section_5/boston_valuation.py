...
def get_dollar_estimate(rm, pt_ratio, chas=False, large_range=True):
    """Estimate the price of a property in Boston.
    
    Keyword arguments:
    rm -- number of rooms in the property.
    ptratio -- number of students per teacher in classroom for the school in the area.
    ...
    # Round the dollar values thousand
